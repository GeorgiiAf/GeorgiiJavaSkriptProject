...
picArray.forEach(pic => {
    ...
    // Create the paragraph element for the description and set its text content
    ...
    article.addEventListener('click', function() {
            ...
            modalImg.src = pic.image.large; // Set large image in the modal
    ...
    dialog.querySelector('span').addEventListener('click', function() {
        dialog.close();
    });
